                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <button
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Registration</span>
                            <svg
                                aria-hidden="true"
                                class="w-6 h-6"
                                fill="currentColor"
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            <li>
                                <a
                                    href="{{ url('/register-member') }}"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Register New Member</a>
                            </li>
                            <li>
                                <a
                                href="{{ url('/register-donor') }}"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Register Donor</a>
                            </li>
                            <li>
                                <a
                            ...
                            <li>
                                <a
                                    href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Donors</a>
                            </li>
                        </ul>
                    </li>
                    <li>
