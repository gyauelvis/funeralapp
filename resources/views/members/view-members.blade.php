        ...
        data.forEach((member, index) => {
            ...
            <td class="px-6 py-4 relative">
                ...
                <div class="popover hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 border border-gray-200 z-50">
                    <ul class="py-1">
                        <li>
                            <a data-modal-target="crud-modal" data-modal-toggle="crud-modal" href="{{ route('member.edit', $member->id) }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">Edit</a>
                        </li>
                        <li>
