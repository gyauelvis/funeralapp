<x-app-layout>
    ...
    <main class="h-auto bg-gray-50 p-4 pt-20 md:ml-64">
            ...
            <div class="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="flex flex-col p-6">
                        <div class="mb-4 flex items-center justify-between">
                            <div class="rounded-full bg-green-50 p-3">
                                <svg class="size-8 text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        ...
                        <div class="mb-2 text-2xl font-bold text-gray-800">
                            {{ Number::currency($contributions->sum('amount'), 'GHS') }}</div>
                ...
                <div
                    ...
                    <div class="flex flex-col p-6">
                        ...
                        <div class="text-sm text-gray-500">Total Community Members</div>
                    </div>
                </div>
                <div
                    class="transform overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
