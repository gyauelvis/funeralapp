                        ...
                        <div class="pt-20">
                            ...
                            <div class="px-6 pb-6">
                                <div class="text-center">
                                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $donor->name }}
                                    </h2>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $donor->denomination }}</p>
                                </div>
                                ...
                                <div class="mt-6 space-y-4">
                                    <div class="flex items-center gap-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700">
                                        ...
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-300">{{ $donor->phone_number }}</span>
                                    </div>
                                    @if ($donor->email !== null)
                                        <div class="flex items-center gap-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700">
                                            <svg class="h-5 w-5 text-gray-600 dark:text-gray-300"
                                            ...
                                            <span
                                                class="text-sm text-gray-600 dark:text-gray-300">{{ $donor->email }}</span>
                                        </div>
                                    @endif
                                    <div class="flex items-center gap-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700">
                                        <svg class="h-5 w-5 text-gray-600 dark:text-gray-300"
                                        ...
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-300">{{ $donor->suburb }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="flex w-full flex-col gap-6 lg:w-2/3">
                        ...
                        <div class="mt-6 grid gap-4 sm:grid-cols-2">
                            ...
                            <div class="rounded-xl bg-green-50 p-4 dark:bg-green-900/20">
                                ...
                                <div class="mt-2 text-2xl font-bold text-green-700 dark:text-green-300">
                                    {{ Number::currency($donations->sum('amount'), 'GHS') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white p-6 shadow-lg transition-all hover:shadow-xl dark:bg-gray-800">
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">All Donations</h2>
                        </div>
                        @if ($donations !== null)
